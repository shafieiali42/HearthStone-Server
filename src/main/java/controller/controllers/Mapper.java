...
//    public void addRequest(OrderTypes requestType) {
//        if (requestType != null)
//            requests.add(requestType);
//    }
//
//    public void executeRequests() {
//        for (Iterator<Order> orderIterator = requests.iterator(); orderIterator.hasNext(); ) {
...
//    }
//
//    public enum OrderTypes implements Order {
//
//        PLAY_CARDS {
//            @Override
//            public void execute() {
//                playCard(Game.getInstance().getPlayingCard(), 7);
//            }
//        },
//        PLAY_CARDS_ONE {
//            @Override
//            public void execute() {
//                playCard(Game.getInstance().getPlayingCard(), 1);
//            }
//        },
//        PLAY_CARDS_TWO {
//            @Override
//            public void execute() {
//                playCard(Game.getInstance().getPlayingCard(), 2);
//            }
//        },
//        PLAY_CARDS_THREE {
//            @Override
//            public void execute() {
//                playCard(Game.getInstance().getPlayingCard(), 3);
//            }
//        },
//        PLAY_CARDS_FOUR {
//            @Override
//            public void execute() {
//               playCard(Game.getInstance().getPlayingCard(), 4);
//            }
//        },
//        PLAY_CARDS_FIVE {
//            @Override
//            public void execute() {
//                playCard(Game.getInstance().getPlayingCard(), 5);
//            }
//        },
//        PLAY_CARDS_SIX {
//            @Override
//            public void execute() {
//                playCard(Game.getInstance().getPlayingCard(), 6);
//            }
//        },
//        PLAY_HERO_POWER {
//            @Override
...
//
//
//    public static void playHeroPower() {
